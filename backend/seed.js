...
const perguntas = [
  ...
  },
  {
    ...
    categoria: "filosofia",
    explicacao:
      "Sartre afirma que o ser humano está 'condenado a ser livre', ou seja, ele é responsável por suas escolhas e não pode se esconder atrás do determinismo. Gerineldo representa a fuga dessa liberdade, ao viver sob uma lógica de previsibilidade total.",
  },
  {
    pergunta:
    ...
    categoria: "fisica",
    explicacao:
      "ela conservação da energia mecânica, toda a energia potencial gravitacional se converte em energia cinética.",
  },
  {
    pergunta:
